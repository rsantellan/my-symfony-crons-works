...
<?php slot('textos'); ?>
<?php slot('nav') ?>Textos<?php end_slot(); ?>
...
<div id="contenido">
  ...
  <div id="backend_right_floating"class="md_right_container" style="float:right;<?php if (!sfConfig::get('sf_plugins_translator_add_new_word', false))
              echo ((isset($_GET['v']) && $_GET['v'] == '1') ? '' : 'display:none'); ?>">
