...
?>
    ...
    <?php echo $form->renderGlobalErrors() ?>
        <form name="<?php echo $form->getName();?>" method="POST" action="<?php echo url_for('@mdContactOptions') ?>">
            ...
            <select id="departamento" name="contacto[area]">
