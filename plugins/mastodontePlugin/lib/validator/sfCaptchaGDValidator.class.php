...
class sfCaptchaGDValidator extends sfValidatorString
{
  ...
  { 
    ...
    //var_dump($clean);    
    if (strtoupper(sfContext::getInstance()->getUser()->getAttribute('captcha', NULL)) != strtoupper($clean))
    {
      //var_dump(sfContext::getInstance()->getUser()->getAttribute('captcha', NULL));
