...
/**
 * PluginmdMediaIssuuVideoTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class PluginmdMediaIssuuVideoTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object PluginmdMediaIssuuVideoTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('PluginmdMediaIssuuVideo');
    }
    ...
    public function retrieveObject($object_id, $timeToLife = 86400, $hydrationMode = Doctrine_Core::HYDRATE_RECORD)
    {
        ...
        $query = $this->createQuery("mdMIV")
                    ->where('mdMIV.id = ?', $object_id);
